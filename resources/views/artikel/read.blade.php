        ...
        <table class="table-fixed">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a href="{{route('edit_batch', $batch->id)}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounde"> edit </a> </td>
                    <td> <a href="{{route('delete_batch', $batch->id)}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"> delete </a> </td>
                </tr>
            @endforeach
            </tbody>

        </table>
        <a href="{{route('create_batch', $artikel->id)}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"> Batch toevoegen </a>
    </div>
</body>
</html>
